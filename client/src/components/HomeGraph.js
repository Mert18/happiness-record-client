  ...
  return (
    <div className="homegraph">
        <svg viewBox="0 0 1280 360">
          <g stroke="black" stroke-width="2" stroke-opacity="20%" class="cls-1">
